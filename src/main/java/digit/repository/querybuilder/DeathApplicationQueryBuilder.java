...
public class DeathApplicationQueryBuilder {
    ...
    private static final String BASE_dtr_QUERY = " SELECT dtr.id as bid, dtr.tenantid as btenantid, dtr.applicationnumber as bapplicationnumber, dtr.deceasedFirstName as bdeceasedFirstName, dtr.deceasedLastName as bdeceasedLastName, dtr.fatherid as bfatherid, dtr.motherid as bmotherid, dtr.doctorname as bdoctorname, dtr.hospitalname as bhospitalname, dtr.placeOfDeath as bplaceOfDeath, dtr.timeOfDeath as btimeOfDeath, dtr.createdby as bcreatedby, dtr.lastmodifiedby as blastmodifiedby, dtr.createdtime as bcreatedtime, dtr.lastmodifiedtime as blastmodifiedtime, ";
